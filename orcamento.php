<?php
$var="Gestão do Orçamento Público";
?>
  				...
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Capacitação de servidores públicos nas áreas de planejamento e orçamento, tornando-os
										 habilitados a organizar, planejar e executar atividades típicas da administração
										 pública relacionadas à gestão do orçamento público;</li>
									<li class="list-group-item">Fornecer aos alunos o conteúdo teórico necessário que o possibilite a atuar em
										qualquer área de gestão do orçamento público;</li>
										<li class="list-group-item">Propiciar aos alunos aprender a prática dos principais atos de organização,
											planejamento e execução das atividades de gestão orçamentária;</li>
										<li class="list-group-item">Efetuar a verificação do aprendizado dos alunos por meio do acompanhamento do
											trabalho de implantação da gestão do orçamento público no órgão contratante;</li>
								</ul>
							</div>
