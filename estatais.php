<?php
$var="Nova Lei N° 13.303/2016 e o Regime Jurídico Das Empresas Estatais";
?>
  				...
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-10 col-sm-offset-1 curso_text">
								<p><b>Fabiano Jantalia</b><br></p>
								<p>Doutorando e Mestre em Direito, Estado e Constituição (UnB). MBA em Finanças (FGV).
									Especialista em Direito do Estado (UERJ). Professor de Direito Econômico e Direito Administrativo
									Econômico em cursos de Pós-Graduação. Instrutor de cursos e programas de treinamento
									promovido em instituições públicas e privado. Autor de livros jurídicos. Consultor Legislativo da
									Câmara dos Deputados. Advogado e parecerista em Brasília. Foi Procurador do Banco Central e
									Advogado da Caixa Econômica Federal. Atuou como Consultor Jurídico Adjunto do Ministério da
									Educação (MEC) e do Ministério da Ciência, Tecnologia e Inovação (MCTI).</p><br>
								<p><b>Alexandre Magno Fernandes Moreira</b><br></p>
								<p>Mestre em Direito pela Vanderbilt University (EUA). Professor de Direito Administrativo.
									Procurador do Banco Central. Foi Consultor Jurídico Adjunto da Matéria Administrativa do Ministério da Educação (MEC).
									Autor de livros e artigos jurídicos, com destaque para a obra “Direito Administrativo Essencial” (Ed. Grancursos, 2011).</p>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Apresentar, de maneira abrangente, consistente e didática, as recentes inovações
										introduzidas no regime jurídico das empresas públicas, das sociedades de economia
										mista e de suas subsidiárias;</li>
									<li class="list-group-item">Apontar os principais impactos diretos e indiretos da nova lei no funcionamento dos
										órgãos ou estruturas de gestão, controle, compras e contratações, bem como de consultoria e assessoramento jurídico de empresas estatais;</li>
								</ul>
							</div>
