                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="col-sm-12 noticia_img">
                                <img src="img/noticia3_grande.jpg" alt="Generic placeholder image">
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-sm-12 noticia_text">
                                Ministro Douglas Alencar (TST) ministra palestra sobre o tema "Intervenção da Justiça do Trabalho nas Relações Sindicais" na Federação dos Trabalhadores em Transportes Rodoviários do Estado de São Paulo - FTTRESP.
                              </div>
                            </div>
                					</div>
                        </div>
