<?php
$var="Novo CPC na Justiça do Trabalho";
?>
  				...
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Ter uma visão panorâmica e sistemática das alterações do Código de Processo Civil, quanto aos principais temas de Direito Processual;</li>
									<li class="list-group-item">Compreender quais as possíveis implicações e tendências processuais, à luz do Novo Código de Processo Civil;</li>
									<li class="list-group-item">Atualizar os conhecimentos sobre a Parte Geral do Processo, os Procedimentos Ordinários e Especiais;</li>
									<li class="list-group-item">Identificar as implicações das alterações processuais com o advento do Novo Código de Processo Civil;</li>
									<li class="list-group-item">Fornecer subsídios para a análise da Execução – cumprimento, processo e defesas;</li>
								</ul>
							</div>
