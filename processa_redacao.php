...
header( "refresh:1;url=http://www.pecastrabalhistas.conectaadvogado.com.br/curso-pecas-trabalhistas" );
...
$cidade = $_POST['cidade'];
$bairro = $_POST['bairro'];
$evento = "Curso de Redação Estratégica de Peças Trabalhistas";
          ...
          <div class='row' style='margin-right: -15px; margin-left: -15px;'>
              ...
              <ul class='list-group'>
								<li class='list-group-item' style='color:#005a9c;'>
								  ...
								  <p>
                    Sua inscrição foi confirmada no evento $evento. Clique no link abaixo para efetuar o pagamento do curso:<br><br>
                    <a href='http://www.pecastrabalhistas.conectaadvogado.com.br/curso-pecas-trabalhistas'><h3>http://www.pecastrabalhistas.conectaadvogado.com.br/curso-pecas-trabalhistas</h3></a>
                  </p>
                </li>
      				</ul>
    				</div>
