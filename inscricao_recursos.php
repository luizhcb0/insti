	...
	<section class="container-fluid" id="content">
		...
		<div class="panel_boots panel-default box">
  		<div class="panel-heading">
    		<h3 class="panel-title">Inscrição<br>Curso: Recursos Trabalhistas de acordo com o novo CPC</h3>
  		</div>
  		<div class="panel-body">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<form class="form-horizontal" action="processa_recursos" method="post">
