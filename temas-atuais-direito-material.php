<?php
$var="Temas atuais de Direito Material e Processual do Trabalho";
?>
			...
			<div class="col-sm-10 col-sm-offset-1">
				<div class="panel_boots panel-default box">
  				<div class="panel-heading curso_titulo">
    				<h3 class="panel-title"><b>Temas atuais de Direito Material e Processual do Trabalho</b></h3>
  				</div>
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Ter uma visão panorâmica e sistemática da evolução legal, jurisprudencial e doutrinária
										quanto aos principais temas de Direito Material e Processual do Trabalho;</li>
									<li class="list-group-item">Compreender os principais institutos processuais e materiais, à luz do atual entendimento
										do Tribunal Superior do Trabalho;</li>
										<li class="list-group-item">Atualizar a jurisprudência sobre legislação trabalhista;</li>
										<li class="list-group-item">Fornecer subsídios para a análise prévia, concomitante e posterior das questões envolvidas
											nos contratos de prestações de serviços;</li>
								</ul>
							</div>
