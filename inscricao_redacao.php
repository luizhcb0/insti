	...
	<section class="container-fluid" id="content">
		...
		<div class="panel_boots panel-default box">
  		<div class="panel-heading">
    		<h3 class="panel-title">Inscrição<br>Curso: Redação Estratégica de Peças Trabalhistas</h3>
  		</div>
  		<div class="panel-body">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<form class="form-horizontal" action="processa_redacao" method="post">
							...
							<div>
    							<br>Ao concluir a inscrição, você será redirecionado ao site para efetuar o pagamento.
  						</div>
