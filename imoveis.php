<?php
$var="Avaliação de Imóveis Urbanos Segundo Norma ABNT NBR 14.653";
?>
  				...
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Apresentar os mecanismos de Avaliação de Imóveis a profissionais de engenharia civil
										e arquitetura designados para realização ou assistência de perícias judiciais;</li>
								</ul>
							</div>
