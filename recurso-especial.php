<?php
$var="Recurso Especial: Requisitos de admissibilidade de acordo com o Novo CPC";
$tar="http://cursos.conectaadvogado.com.br/cursos/recurso-especial-requisitos-de-admissibilidade-de-acordo-com-o-novo-cpc";
?>
  				...
  				<div class="panel-body curso_body">
						<div class="row">
							<div class="col-sm-4 curso_text">
								...
								Advogados, bacharéis em Direito e estudantes.</p>
							</div>
							<div class="col-sm-8 curso_text">
								<p><b>Este curso é voltado ao estudo dos requisitos de admissibilidade do Recurso Especial,
									notadamente os concernentes ao cabimento, tempestividade, regularidade formal e preparo, em consonância com as mudanças advindas do Novo Código de Processo Civil.</b></p>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-6 curso_text">
								<p><b>César Augusto Binder</b><br></p>
								<p>Mestre em Direito<br>
									Procurador do Estado do Paraná<br>
									Professor em diversos cursos de graduação e pós-graduação.</p><br>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 curso_label_container">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Compreender as características do recurso especial e de seus requisitos de admissibilidade.</li>
									<li class="list-group-item">Identificar, compreender e dominar criticamente, a utilização dos recurso especial, os seus requisitos de admissibilidade, com atenção especial aos seus aspectos práticos.</li>
								</ul>
							</div>
