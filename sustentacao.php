			...
			<div class="col-sm-10 col-sm-offset-1">
				<div class="panel_boots panel-default box">
  				<div class="panel-heading curso_titulo">
    				<h3 class="panel-title"><b>Sustentação Oral</b></h3>
  				</div>
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Aprender as técnicas utilizadas nas interações diárias da prática jurídica.</li>
									<li class="list-group-item">Desenvolver as habilidades necessárias para a prática da sustentação oral em Tribunais e outros ambientes
										da rotina do advogado, como as audiências em órgãos públicos diversos:<br>
										<ul>
											<li>órgãos fiscalizadores;</li>
											<li>agências reguladoras;</li>
											<li>órgãos do Ministério do Trabalho;</li>
											<li>Conselhos Julgadores;</li>
											<li>outros locais de atuação do advogado;</li>
										</ul>
									</li>
								</ul>
							</div>
