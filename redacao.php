			...
			<div class="col-sm-10 col-sm-offset-1">
				<div class="panel_boots panel-default box">
  				<div class="panel-heading curso_titulo">
    				<h3 class="panel-title"><b>Curso de Redação Estratégica de Peças Trabalhistas</b></h3>
  				</div>
  				<div class="panel-body curso_body">
						
						<div class="row">
							<div class="col-sm-6 curso_img" id="redacao_img">
								<img src="img/curso_redacao1.jpeg">
							</div>
							<div class="col-sm-6 curso_text">
								<p><h3>
								<p>1. Petição Inicial</p>
								<p>2. Contestação</p>
								<p>3. Recurso Ordinário</p>
								<p>4. Agravo de Petição</p>
								<p>5. Embargos de Declaração</p>
								<p>6. Recurso de Revista</p>
								<p>7. Embargos à SDI 1</p>
								<p>8. Agravo de Instrumento</p>
								<p>9. Recurso de Revista</p><br>
								<p>Bônus: Sustentação Oral e Memoriais</h3></p></p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 inscricao">
								<button type="button" class="btn btn-primary" onclick="window.location='inscricao_redacao';">Inscrição</button>
							</div>
						</div>
  				</div>
				</div>
