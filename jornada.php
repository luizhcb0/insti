<?php
$var="Estudo sobre jornada de trabalho e controle de frequência";
?>
  				...
  				<div class="panel-body curso_body">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2 curso_text">
								...
								<p>Estudo sistematizado sobre as possibilidades e limites quanto ao controle e a flexibilização
									da jornada no âmbito da contratante, à luz das tendências da jurisprudência trabalhista sobre o tema:<br>
									"Aspectos gerais, controle de frequência, banco de horas, tolerância do início da jornada, registro e intervalos."</p>
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Estabelecer os conceitos gerais sobre o tema Jornada de Trabalho, conforme a legislação em vigor e a jurisprudência trabalhista vigente;</li>
									<li class="list-group-item">Apresentar o quadro atual do tema Jornada de Trabalho, a luz da jurisprudência dos tribunais, para compreensão de todos os envolvidos na discussão;</li>
									<li class="list-group-item">Fazer um levantamento das eventuais vulnerabilidades trabalhistas quanto às práticas adotadas pela contratante;</li>
									<li class="list-group-item">Subsidiar o departamento jurídico no seu trabalho de discussão e orientação com as partes envolvidas;</li>
									<li class="list-group-item">Proporcionar uma visão dos pontos em destaque sobre Jornada de Trabalho, conforme os aspectos relevantes na discussão da implantação de controle eletrônico de ponto;</li>
									<li class="list-group-item">Estabelecer os aspectos relevantes e essenciais para a compreensão do tema Jornada de Trabalho, conforme as tendências jurisprudências, apontando as imposições jurídicas para a implantação do controle de ponto eletrônico;</li>
									<li class="list-group-item">Sugerir eventuais estratégias na condução da gestão da força de trabalho sob a perspectiva das possibilidades e limites traçados pela legislação e à luz da jurisprudência sobretudo do Tribunal Superior do Trabalho;</li>
								</ul>
							</div>
