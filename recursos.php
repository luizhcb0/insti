			...
			<div class="col-sm-10 col-sm-offset-1">
				<div class="panel_boots panel-default box">
  				<div class="panel-heading curso_titulo">
    				<h3 class="panel-title"><b>Recursos Trabalhistas de acordo com o novo CPC</b></h3>
  				</div>
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Conhecer os princípios que informam os recursos em geral e os recursos trabalhistas, em específico.</li>
									<li class="list-group-item">Analisar os pressupostos de admissibilidade (comuns e específicos) dos recursos que podem ser interpostos na Justiça do Trabalho e, particularmente, os dirigidos ao TST.</li>
									<li class="list-group-item">Oferecer uma visão geral sobre os recursos trabalhistas, em espécie, destacando aspectos práticos que devem ser observados pelos advogados que atuam na Justiça do Trabalho.</li>
									<li class="list-group-item">Apresentar as inovações na arquitetura recursal com a edição da Lei 13.015/14.</li>
								</ul>
							</div>
						...
						<div class="row">
							<div class="col-sm-12" style="color:#05589c;">
								<br> <h4>Curso com inscrições encerradas!<br>Para mais informações sobre a abertura de novas turmas, preencha o formulário.</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 inscricao">
								<button type="button" class="btn btn-primary" onclick="window.location='inscricao_recursos';">Formulário</button>
							</div>
						</div>
  				</div>
				</div>
