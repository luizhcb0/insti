<?php
$var="O recurso de revista e o recurso ordinário à luz da Lei 13.015/14";
?>
  				...
  				<div class="panel-body curso_body">
						...
						<div class="row">
							<div class="col-sm-7 curso_text">
								<ul class="list-group">
									<li class="list-group-item">Ter uma visão panorâmica e sistemática da evolução legal, jurisprudencial e doutrinária quanto aos principais temas relativos à interpretação da Lei 13.105/14;</li>
									<li class="list-group-item">Compreender os principais institutos regulados pela Lei 13.015/14, sobretudo a sistemática de recursos repetitivos e o incidente de uniformização de jurisprudência;</li>
								</ul>
							</div>
